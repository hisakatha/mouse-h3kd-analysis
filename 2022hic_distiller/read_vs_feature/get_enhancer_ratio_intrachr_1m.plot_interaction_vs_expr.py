...
prefix = "get_enhancer_ratio_intrachr_1m"
...
for (idx, (sample, feature1_summary)) in enumerate(feature1_summaries.items()):
    ...
    hb = ax.hexbin(d2[sample_name_in_tpm], d2["num_reads_with_feature2"], xscale="log", yscale="linear", gridsize=25, extent=(0,4,0,50), bins="log")
