...
WIDTH="1k"
INTERGENIC_BIN="../../mouse_ref/Ensembl_direct/GRCm38/Annotation/Mus_musculus.GRCm38.102.sorted.gene_and_nc.merged.sorted.subtract_bin$WIDTH.bed"
GENIC_BIN="../../mouse_ref/Ensembl_direct/GRCm38/Annotation/Mus_musculus.GRCm38.102.sorted.gene_and_nc.merged.sorted.intersect_bin$WIDTH.bed"
# output files
TEMPLATE_INTERGENIC_BIN="Aligned.sortedByCoord.out.uniq_collated.template.sorted.merged.intergene_rounded_bin$WIDTH.bed"
TEMPLATE_INTERGENIC_NOOVERHANG_READ="Aligned.sortedByCoord.out.uniq_collated.template.sorted.intergene_nooverhang_bin$WIDTH.bed"
TEMPLATE_INTERGENIC_NOOVERHANG="Aligned.sortedByCoord.out.uniq_collated.template.sorted.intergene_nooverhang_bin$WIDTH.merged.bed"
TEMPLATE_INTERGENIC_NOOVERHANG_BIN="Aligned.sortedByCoord.out.uniq_collated.template.sorted.intergene_nooverhang.merged.rounded_bin$WIDTH.bed"
