...
count_prefix = "Aligned.sortedByCoord.out.uniq_collated.template.sorted.nooverhang_outside_gene_slop"
...
output_path = "template_count_outside_gene.summarize.csv"
