...
m2_rep1_name <- "MII #1"
m2_rep1_path <- sprintf("./NoRibs_MII201209/Aligned.sortedByCoord.out.uniq_collated.template.sorted.intergene_nooverhang.merged.rounded_bin%s.bed", bin_width)
...
m2_rep1_intergenic_read_count_main <- fread(sprintf("./NoRibs_MII201209/Aligned.sortedByCoord.out.uniq_collated.template.sorted.intergene_nooverhang_bin%s.bed.count_main", bin_width), header = FALSE)[[1,1]]
m2_rep2_name <- "MII #2"
m2_rep2_path <- sprintf("./NoRibs_MII201218/Aligned.sortedByCoord.out.uniq_collated.template.sorted.intergene_nooverhang.merged.rounded_bin%s.bed", bin_width)
...
m2_rep2_intergenic_read_count_main <- fread(sprintf("./NoRibs_MII201218/Aligned.sortedByCoord.out.uniq_collated.template.sorted.intergene_nooverhang_bin%s.bed.count_main", bin_width), header = FALSE)[[1,1]]
m2_mean_name <- "MII"

twocell18h_rep1_name <- "2C 18hpi #1"
twocell18h_rep1_path <- sprintf("./NoRibs_2c_18hpi201209/Aligned.sortedByCoord.out.uniq_collated.template.sorted.intergene_nooverhang.merged.rounded_bin%s.bed", bin_width)
...
twocell18h_rep1_intergenic_read_count_main <- fread(sprintf("./NoRibs_2c_18hpi201209/Aligned.sortedByCoord.out.uniq_collated.template.sorted.intergene_nooverhang_bin%s.bed.count_main", bin_width), header = FALSE)[[1,1]]
twocell18h_rep2_name <- "2C 18hpi #2"
twocell18h_rep2_path <- sprintf("./NoRibs_2c_18hpi201218/Aligned.sortedByCoord.out.uniq_collated.template.sorted.intergene_nooverhang.merged.rounded_bin%s.bed", bin_width)
...
twocell18h_rep2_intergenic_read_count_main <- fread(sprintf("./NoRibs_2c_18hpi201218/Aligned.sortedByCoord.out.uniq_collated.template.sorted.intergene_nooverhang_bin%s.bed.count_main", bin_width), header = FALSE)[[1,1]]
twocell18h_mean_name <- "2C 18hpi"

twocell_noinj_rep1_name <- "2C NoInjection #1"
twocell_noinj_rep1_path <- sprintf("./NoRibs_2c_Noinjection201209/Aligned.sortedByCoord.out.uniq_collated.template.sorted.intergene_nooverhang.merged.rounded_bin%s.bed", bin_width)
...
twocell_noinj_rep1_intergenic_read_count_main <- fread(sprintf("./NoRibs_2c_Noinjection201209/Aligned.sortedByCoord.out.uniq_collated.template.sorted.intergene_nooverhang_bin%s.bed.count_main", bin_width), header = FALSE)[[1,1]]
twocell_noinj_rep2_name <- "2C NoInjection #2"
twocell_noinj_rep2_path <- sprintf("./NoRibs_2c_Noinjection201218/Aligned.sortedByCoord.out.uniq_collated.template.sorted.intergene_nooverhang.merged.rounded_bin%s.bed", bin_width)
...
twocell_noinj_rep2_intergenic_read_count_main <- fread(sprintf("./NoRibs_2c_Noinjection201218/Aligned.sortedByCoord.out.uniq_collated.template.sorted.intergene_nooverhang_bin%s.bed.count_main", bin_width), header = FALSE)[[1,1]]
twocell_noinj_mean_name <- "2C NoInjection"

twocell_control_rep1_name <- "2C Control #1"
twocell_control_rep1_path <- sprintf("./NoRibs_2c_Control201209/Aligned.sortedByCoord.out.uniq_collated.template.sorted.intergene_nooverhang.merged.rounded_bin%s.bed", bin_width)
...
twocell_control_rep1_intergenic_read_count_main <- fread(sprintf("./NoRibs_2c_Control201209/Aligned.sortedByCoord.out.uniq_collated.template.sorted.intergene_nooverhang_bin%s.bed.count_main", bin_width), header = FALSE)[[1,1]]
twocell_control_rep2_name <- "2C Control #2"
twocell_control_rep2_path <- sprintf("./NoRibs_2c_Control201218/Aligned.sortedByCoord.out.uniq_collated.template.sorted.intergene_nooverhang.merged.rounded_bin%s.bed", bin_width)
...
twocell_control_rep2_intergenic_read_count_main <- fread(sprintf("./NoRibs_2c_Control201218/Aligned.sortedByCoord.out.uniq_collated.template.sorted.intergene_nooverhang_bin%s.bed.count_main", bin_width), header = FALSE)[[1,1]]
twocell_control_mean_name <- "2C Control"

twocell_h3kd_rep1_name <- "2C H3.1/3.2 KD #1"
twocell_h3kd_rep1_path <- sprintf("./NoRibs_2c_H3_1_3_2KD201209/Aligned.sortedByCoord.out.uniq_collated.template.sorted.intergene_nooverhang.merged.rounded_bin%s.bed", bin_width)
...
twocell_h3kd_rep1_intergenic_read_count_main <- fread(sprintf("./NoRibs_2c_H3_1_3_2KD201209/Aligned.sortedByCoord.out.uniq_collated.template.sorted.intergene_nooverhang_bin%s.bed.count_main", bin_width), header = FALSE)[[1,1]]
twocell_h3kd_rep2_name <- "2C H3.1/3.2 KD #2"
twocell_h3kd_rep2_path <- sprintf("./NoRibs_2c_H3_1_3_2KD201218/Aligned.sortedByCoord.out.uniq_collated.template.sorted.intergene_nooverhang.merged.rounded_bin%s.bed", bin_width)
...
twocell_h3kd_rep2_intergenic_read_count_main <- fread(sprintf("./NoRibs_2c_H3_1_3_2KD201218/Aligned.sortedByCoord.out.uniq_collated.template.sorted.intergene_nooverhang_bin%s.bed.count_main", bin_width), header = FALSE)[[1,1]]
twocell_h3kd_mean_name <- "2C H3.1/3.2 KD"

twocell_dnaminus_rep1_name <- "2C DNA(-) #1"
twocell_dnaminus_rep1_path <- sprintf("./NoRibs_2cAphidicolin201209/Aligned.sortedByCoord.out.uniq_collated.template.sorted.intergene_nooverhang.merged.rounded_bin%s.bed", bin_width)
...
twocell_dnaminus_rep1_intergenic_read_count_main <- fread(sprintf("./NoRibs_2cAphidicolin201209/Aligned.sortedByCoord.out.uniq_collated.template.sorted.intergene_nooverhang_bin%s.bed.count_main", bin_width), header = FALSE)[[1,1]]
twocell_dnaminus_rep2_name <- "2C DNA(-) #2"
twocell_dnaminus_rep2_path <- sprintf("./NoRibs_2c_Aphidicoilin201218/Aligned.sortedByCoord.out.uniq_collated.template.sorted.intergene_nooverhang.merged.rounded_bin%s.bed", bin_width)
...
twocell_dnaminus_rep2_intergenic_read_count_main <- fread(sprintf("./NoRibs_2c_Aphidicoilin201218/Aligned.sortedByCoord.out.uniq_collated.template.sorted.intergene_nooverhang_bin%s.bed.count_main", bin_width), header = FALSE)[[1,1]]
...
pdf_path <- sprintf("count_intergenic_bin_with_read.template_bin%s.pdf", bin_width)
...
pdf_path2 <- sprintf("count_intergenic_bin_with_read.template_bin%s.per_bin.pdf", bin_width)
