...
WIDTH="50k"
GENIC_REGION="../../mouse_ref/Ensembl_direct/GRCm38/Annotation/Mus_musculus.GRCm38.102.sorted.gene_and_nc.merged.sorted.slop$WIDTH.merged.bed"

# output files
TEMPLATE_INTERGENIC_NOOVERHANG_READ="Aligned.sortedByCoord.out.uniq_collated.template.sorted.nooverhang_outside_gene_slop$WIDTH.bed"
